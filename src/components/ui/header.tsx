                        ...
                        {loading ? (
                            ...
                            <>
                                <a
                                    ...
                                    className="hidden sm:flex px-4 py-2 border border-green-500/50 bg-white text-gray-700 text-sm font-medium rounded-md hover:bg-green-50 hover:text-green-700 hover:border-green-500 transition-all items-center gap-2 shadow-[0_0_10px_rgba(34,197,94,0.3)] hover:shadow-[0_0_15px_rgba(34,197,94,0.5)]"
                                >
