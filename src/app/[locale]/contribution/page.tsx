    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-900">
            ...
            <main className="max-w-7xl mx-auto px-6 py-12">
                <div className="mb-10">
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">{t('myImpact')}</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-sm font-medium text-gray-500">{t('treesPlantedLabel')}</h3>
                        ...
                        <div className="flex items-baseline gap-2">
                            ...
                            <span className="text-sm text-gray-500">{t('treesUnit')}</span>
                        </div>
                        <p className="text-xs text-green-600 mt-2 font-medium">
                            {stats.verifiedPlantationsCount !== undefined
                                ? t('nVerified', { count: stats.verifiedPlantationsCount })
                                : (stats.verifiedContributions > 0 ? t('nVerified', { count: stats.verifiedContributions }) : t('nVerified', { count: 0 }))
                            }
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-sm font-medium text-gray-500">{t('treesDonatedLabel')}</h3>
                        ...
                        <div className="flex items-baseline gap-2">
                            ...
                            <span className="text-sm text-gray-500">{t('supportedUnit')}</span>
                        </div>
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-sm font-medium text-gray-500">{t('lifetimeOxygen')}</h3>
                        ...
                        <div className="flex items-baseline gap-2">
                            ...
                            <span className="text-sm text-gray-500">{t('kgUnit')}</span>
                        </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                        <div className="p-6 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
                            <h2 className="font-bold text-gray-900">{t('activityHistory')}</h2>
                        </div>
                        ...
                        {data && data.contributions.length === 0 && data.donations.length === 0 ? (
                            <div className="p-12 text-center">
                                ...
                                <p className="text-gray-500 mb-6 max-w-sm mx-auto">{t('noActivityDesc')}</p>
                                <div className="flex justify-center gap-4">
                                    <Link href="/plant" className="px-4 py-2 bg-gray-900 text-white rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors">
                                        {t('plantTreeBtn')}
                                    </Link>
                                    <Link href="/donate" className="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors">
                                        {t('donateBtn')}
                                    </Link>
                                </div>
                            </div>
                                                ...
                                                <div>
                                                    <div className="flex items-baseline gap-2 mb-1">
                                                        <span className="font-semibold text-gray-900">
                                                            {t('planted', { qty: contribution.treeQuantity || 1, name: contribution.treeName || 'Tree' })}
                                                        </span>
                                                        <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wide
                                                            ...
                                                            {t(`status.${contribution.status.toLowerCase() as 'verified' | 'pending' | 'rejected'}`)}
                                                        </span>
                                                    </div>
                                            ...
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-gray-900 mb-1">
                                                        {t('donatedVia', { qty: donation.treeCount, name: donation.treeName || 'Trees', ngo: donation.ngoReference })}
                                                    </p>
                                                    <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm text-gray-500">
                                                        <span className="flex items-center gap-1">
                                                            <Calendar className="w-3.5 h-3.5" />
